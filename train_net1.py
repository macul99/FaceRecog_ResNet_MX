...
trainIter = MyImageIter_IndividualLabel(
                                ...
                                data_name='data',                  
                                #label_name=['softmax_label'],          # for train_insight.rec
                                #label_len=[1,],                        # for train_insiht.rec
                                label_idx=0,
                                rand_mirror = config.Aug_rand_mirror)
'''
...
testIter = MyImageIter_IndividualLabel(
                                                batch_size=batchSize, 
                                                data_shape=config.Data_Shape,
                                path_imgrec=config.TEST_MX_REC,
                                mean = [means["R"], means["G"], means["B"]],
